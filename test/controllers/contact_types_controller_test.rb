...
class ContactTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_type" do
    assert_difference("ContactType.count") do
      post contact_types_url, params: { contact_type: { description: @contact_type.description, title: @contact_type.title } }
    end
  ...
  test "should update contact_type" do
    patch contact_type_url(@contact_type), params: { contact_type: { description: @contact_type.description, title: @contact_type.title } }
