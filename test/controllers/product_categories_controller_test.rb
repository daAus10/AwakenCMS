...
class ProductCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_category" do
    assert_difference("ProductCategory.count") do
      post product_categories_url, params: { product_category: { description: @product_category.description, link: @product_category.link, title: @product_category.title } }
    end
  ...
  test "should update product_category" do
    patch product_category_url(@product_category), params: { product_category: { description: @product_category.description, link: @product_category.link, title: @product_category.title } }
