...
class ServiceCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_category" do
    assert_difference("ServiceCategory.count") do
      post service_categories_url, params: { service_category: { description: @service_category.description, link: @service_category.link, title: @service_category.title } }
    end
  ...
  test "should update service_category" do
    patch service_category_url(@service_category), params: { service_category: { description: @service_category.description, link: @service_category.link, title: @service_category.title } }
